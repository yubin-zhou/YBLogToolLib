...
Pod::Spec.new do |s|
  s.name             = 'YBLogToolLib'
  s.version          = '0.1.0'
  s.summary          = 'A short description of YBLogToolLib.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhouyubin/YBLogToolLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhouyubin' => 'zhouyubinwangyi@163.com' }
  s.source           = { :git => 'https://github.com/zhouyubin/YBLogToolLib.git', :tag => s.version.to_s }
